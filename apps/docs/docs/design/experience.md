...
本文件是「什么是Experience / 如何分版本 / 全流程」的唯一权威源（[anatomy 决议 — 仓库原文](https://github.com/embaobao/agentsignal/blob/main/docs/decisions/2026-08-27-experience-anatomy-versioning.md) · [MCP 提前决议 — 仓库原文](https://github.com/embaobao/agentsignal/blob/main/docs/decisions/2026-08-27-mcp-early-access.md)）。术语外的一切冲突以本文为准。
...
生成产物规范：use 物化出的本地技能文件遵循 [templates/SKILL.generated.md — 仓库原文](https://github.com/embaobao/agentsignal/blob/main/templates/SKILL.generated.md)（六字段 frontmatter + Source/Experience/Runbook 三区 + 稳定加载三规则）。

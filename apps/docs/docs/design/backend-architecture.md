...
> 配套文档：[design-driven-proposal.md — 仓库原文](https://github.com/embaobao/agentsignal/blob/main/docs/design/design-driven-proposal.md)（总提案）/ [audit-restore-proposal.md — 仓库原文](https://github.com/embaobao/agentsignal/blob/main/docs/design/audit-restore-proposal.md)（独立模块）
...
## 三、存储：标准 Postgres（历史：P3 文件存储 → PGlite 均已被 [standardize-node-postgres 决议 — 仓库原文](https://github.com/embaobao/agentsignal/blob/main/docs/decisions/2026-08-28-standardize-node-postgres.md) 取代）

...
const dict = {
  zh: {
    ...
    "term.human.1": "# 复制这条链接，发给你的 Agent",
    "term.human.2": "# 剩下的它自己读完、自己接好",
    "term.agent.note": "# 这是你的接入说明书 —— 读完照做即可",
  ...
  en: {
    ...
    "term.human.1": "# Copy this link and send it to your agent",
    "term.human.2": "# It reads the rest and wires itself up",
    "term.agent.note": "# This is your onboarding doc — read it, then follow it.",
    "term.sig": "sig_01M1B90PZ1Z1BWFNFAWD4RP4GD",
  },
} as const;

...
| 2026-09-12 | 夜间通用轨（06:00 修复轮） | R5-a 审查整改（席6 报，限 1.7 前闭环）——removeYamlHook 由整块删除改逐条删除（同 event 块用户自有 command 毫发无损·块删空才清 event 键）；红测先行抓出测试漏 import 即修；CLI 138/138 · check/lint 绿 | ✅ 待审查 | `9c5c9bd`

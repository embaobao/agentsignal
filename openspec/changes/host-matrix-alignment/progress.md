...
| 2026-09-15 | 夜间通用轨（00:00 轮） | 1.8 测试收口——核对 design §五：三断言（探测/写入/摘除）与专项 3 条已被 1.1–1.7 单元测试分摊覆盖（wiring-hermes/hostskill/hermeshook/soul 四文件 19 用例）；本笔补「探测命中」用例闭最后缺口；Phase 1 夜间面只剩 1.9 真机走查（站长项）；CLI 191/191 · check/lint 绿 | ✅ 待审查 | (sha见下笔)

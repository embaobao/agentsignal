...
| 2026-09-13 | 席1·主轨开发（轨道A） | 1.3 归属账本——capability/ledger.ts（schema v1·Ledger/Entry/Snapshot 接口·loadLedger 损坏零阻断·appendLedger tmp+rename+进程内 promise 链互斥·snapshotOf sha256 自足·ledgerExists）；并发 10 append 零丢写断言；CLI 167/167 · check/lint 绿 | ✅ 待审查 | (sha见下笔)

...
| 2026-09-13 | 席1·主轨开发（轨道A） | 1.4 归属锁——capability/lock.ts（acquireHostLock 规则二互斥·HostLockConflict 含持锁方+unwire 建议·release 幂等·lockHolder 只读查询；进程内 Map 语义，跨进程归 P2 装载接线）；冲突/释放/复得三断言；CLI 170/170 · check/lint 绿 | ✅ 待审查 | (sha见下笔)

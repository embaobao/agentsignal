...
| 2026-09-15 | 席1·主轨开发（轨道A） | 1.6 APM 适配器——capability/adapters/apm.ts（probe spawn 探测缺席 reason/DECLARED_CAPS 不含 remove/remove 门控抛 UnsupportedCapability/hosts 五宿主·deploy/reconcile 占位注记待 G-B）；capability-apm.test.ts 4 用例（PATH 沙箱 fake apm 取版本/缺席降级/规则一）；CLI 204/204 · check/lint 绿 | ✅ 待审查 | (sha见下笔)

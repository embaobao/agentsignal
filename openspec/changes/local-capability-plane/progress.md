...
| 2026-09-15 | 夜间通用轨（06:00 修复轮） | 审查移交清零：1.6/1.7 勘误（降级夹具实属 1.7 已勾·1.6=apm 适配器保持待认领·d3966d7 误挂注记）· 补 importApm skipped 分支用例（DoD 3 用例回账）· C2 加「ladder≠L1⇒skipped/warnings 非空」结构断言（多档盲区闭合）· check-ledger 重复 return 清理；残留 1 项=d3966d7 历史误挂（勘误注记在案，与 0.1-0.4 同类豁免）；CLI 200/200 · check/lint 绿 | ✅ 待审查 | (sha见下笔)

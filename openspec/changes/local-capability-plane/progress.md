...
| 2026-09-16 | 夜间通用轨（02:00 轮） | 7.1 供应商注册表——capability/providers.ts（ProviderSchema·内置国产端点打底 GLM/DeepSeek/Moonshot·用户区 providers.json5 覆盖/追加·fail-soft 收集·token 永不进注册表）；capability-providers.test.ts 4 用例；CLI 211/211 · 限定域门禁绿 | ✅ 待审查 | (sha见下笔)
